...
train <- read_csv("../../../../data/customerreturntrain.csv") 
test  <- read_csv("../../../../data/customerreturntest.csv") 
...
train_path <- file.path("../../../data", "customerReturnTrain.csv")
test_path  <- file.path("../../../data", "customerReturnTest.csv")
