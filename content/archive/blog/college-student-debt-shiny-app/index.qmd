...
allAgesDf <- read_csv("../../../data/all-ages.csv")
tuition_cost <- read_csv("../../../data/tuition_income.csv")
tuition <- read_csv("../../../data/tuition_cost.csv")
ds4 <- read_csv("../../../data/salary_and_stats.csv")
